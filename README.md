...
The default value contains a a default extra worker group "gpu" to illustrate
how to create a specific worker-group
...
to retrieve the IP of your minikube and adjust your values.yaml file to adapt to
the ip address

```
windmill.baseUrl: http://<IP>
```

Windmill should be available at http://<IP> . Default credentials:
...
You will want to update the baseUrl to point to your ingress or load balancer.
